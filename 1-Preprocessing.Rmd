...
sscs <- BiocParallel::bplapply(
  ...
  function(mse) {
    ...
    ssc <- spatialShrunkenCentroids(mse, k = 6, weights = "adaptive")
    ssc
  },
  BPPARAM = bp
)
...
mvs_cartilage_class <- list("6891-OA-lateral" = c(1), 
                        "6891-OA-medial" = c(1),
                        "6908-OA-lateral" = c(5),
                        "6908-OA-medial" = c(1),
                        "6919-CAD-lateral" = c(1), 
                        "6919-CAD-medial" = c(1),
                        "6924-CAD-lateral" = c(5),
                        "6924-CAD-medial" = c(3),
                        "6938-CAD-lateral" = c(4),
                        "6938-CAD-medial" = c(2),
...
png(filename = "glufib_isos.png", width = 8000, height = 2000, bg = "black")
image(m, i = bg_idx, grid = F, key = F, style= "dark", layout = c(7,16), scale = T)
dev.off()
```
...
normalized <- m |>
        normalize(method = "reference", ref = 1570.6763, scale = 1000) |>
