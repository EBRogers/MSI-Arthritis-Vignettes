...
The base images can be regenerated with the commented code below, but it is very time-consuming. We will simply load the images from the RData object supplied.
...
sim_list_original_path <- file.path("Simulation-Data", "sim_list_original.RData")
